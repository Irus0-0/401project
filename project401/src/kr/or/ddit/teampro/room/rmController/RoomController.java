...
public class RoomController {
    ...
    public RoomController() {
        ...
        companyVO = CompanyService.getInstance().getVo();
...
//			1을 입력시 객실등급으로 검색
            if (choice == 1) {
                ...
                System.out.print("이상: ");
                int minGrade = Integer.parseInt(scan.nextLine());
                System.out.print("이하: ");
                int maxGrade = Integer.parseInt(scan.nextLine());
...
//			3를 입력시 적정인원으로 검색
            if (choice == 3) {
                ...
                System.out.print("이상: ");
                int minAppro = Integer.parseInt(scan.nextLine());
                System.out.print("이하: ");
                int maxAppro = Integer.parseInt(scan.nextLine());
